...
export const MathAssistant: React.FC = () => {
    ...
    useEffect(() => {
        addMessage(MessageAuthor.ASSISTANT, "Tối nay, cả lớp hãy tham gia thử thách '10 cửa ải toán học' với trợ lý Gemini. Mỗi câu hỏi được +10 điểm/câu, nếu trả lời sai cho phép làm lại 1 lần duy nhất, nếu làm lại đúng chỉ được +5 điểm. Ai đạt 100/100 điểm hãy chụp màn hình gửi cô nhé!");
    }, []);
